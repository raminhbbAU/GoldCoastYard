...
import { AlternativeWayTitle, ContactFormContainer, EnquirePhone, EnquireTitle, LocationTitle, MainTitle, SaleDepartmentTitle, SalePhone, SalePhoneContainer } from "./styles";
